...
<body class="bg-slate-50 text-slate-800 antialiased selection:bg-orange-500 selection:text-white flex flex-col min-h-screen">
                ...
                <form id="formBookingTransaction" onsubmit="handleBookingTransactionSubmit(event)" class="space-y-2.5">
                    ...
                    <div class="p-2.5 bg-slate-50 border border-slate-200 rounded-xl flex items-center justify-between">
                        ...
                        <div class="text-right shrink-0 pl-2">
                            ...
                            <span id="transRoomPriceBase" class="text-xs sm:text-sm font-black text-navy-900">Rp 0 / bln</span>
                        </div>
                    </div>
    ...
    <script>
        ...
        function openBookingTransactionModal(roomId, roomNumber) {
            ...
            document.getElementById('transDuration').value = '1 Bulan';
            document.getElementById('transAmount').value = currentBookingPrice;
            ...
            document.getElementById('transRoomPriceBase').textContent = 'Rp ' + Number(currentBookingPrice).toLocaleString('id-ID') + ' / bln';
            document.getElementById('transTotalDisplay').textContent = 'Rp ' + Number(currentBookingPrice).toLocaleString('id-ID');
